...
//                    '</a>',
                ...
                {
                    echo
                    '<p style="border-bottom: 1px solid #ddd; padding-bottom: 5px; font-style: italic; color: #777; margin: 10px 0 50px 0; padding-left: 5px;">', $this->article->caption_1, '</p>';
                }
