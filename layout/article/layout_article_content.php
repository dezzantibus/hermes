...
//                    '</a>',
                ...
                {
                    echo
                    '<p style="border-bottom: 1px solid #777; padding-bottom: 5px; font-style: italic; color: #777; margin: 10px 0 50px 0; font-size: 12px; padding-left: 5px;">', $this->article->caption_1, '</p>';
                }
